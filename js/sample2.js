...
function init() {
    ...
    new THREE.MTLLoader()
    .setPath( 'https://finalar.github.io/models/Shoes/' )
    .load( '10493_Leather_Boxing_Gloves_V1_L3.mtl', function ( materials ) {
        materials.preload();
        new THREE.OBJLoader()
            .setMaterials( materials )
            .setPath( 'https://finalar.github.io/models/Shoes/' )
            .load( '10493_Leather_Boxing_Gloves_V1_L3.obj', function ( group ) {
    ...
    loader.load(
        ...
        "https://followthedarkside.github.io/arjs-image-tracking-sample/resources/LeePerrySmith.glb",
